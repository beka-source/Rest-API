...
from eddo_service_api.extensions import pwd_context
from eddo_service_api.models import Book


def test_get_book(client, db, book):
    # test 404
    book_url = url_for('api.book_by_id', book_id="100000")
    ...
    assert data["titles"] == book.titles
